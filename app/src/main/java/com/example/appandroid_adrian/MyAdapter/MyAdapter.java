package com.example.appandroid_adrian.MyAdapter;
...
import com.example.appandroid_adrian.R;
...
public class MyAdapter extends BaseAdapter implements Serializable {
    ...
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        textView= view.findViewById(R.id.textUsser);
        textView1=view.findViewById(R.id.textPass);
