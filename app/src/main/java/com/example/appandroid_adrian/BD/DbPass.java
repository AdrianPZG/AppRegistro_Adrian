package com.example.appandroid_adrian.BD;
...
import com.example.appandroid_adrian.contract.UsuariosContract;
...
public class DbPass extends UsuariosDBService {
    ...
    public List<MyData> getPass(int id )
    {
        ...
        for( int i = 0; i < cursor.getCount(); i++)
        {
            ...
            myData.setUsuario(cursor.getString(1));
            myData.setEmail(cursor.getString(2));
            contras.add(myData);
            cursor.moveToNext( );
        }
